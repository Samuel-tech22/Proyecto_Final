...
const CheckoutPage = () => {
  ...
  const confirmarPedido = () => {
    ...
    if(cart.length > 0){
      axios.post(`${apiUrl}/ventas`, venta).then((res) => {
          ...
          <div className="">
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col">
                  <button onClick={confirmarPedido} className="p-2 w-full bg-[#666666] font-bold text-white flex items-center justify-between px-8">
                    Confirmar pedido
          ...
          <div className=" pt-12">
            ...
            <div className="mt-4 w-[80%]">
              <p className="text-sm font-bold text-red-400">
                ¡Bien! Haz tu pedido y lo gestionaremos dentro de nuestro horario de apertura.
              </p>
            </div>
            <div className="mt-4 w-[80%]">
              <p className="text-sm">
                <FontAwesomeIcon color="grey" icon={faClock} />¡Cerrado ahora!
              </p>
            </div>
            <div className="mt-4 w-[80%]">
      ...
      <div className="p-12 text-center text-lg flex flex-col justify-center items-center">
        ...
        <p className="mt-4 bg-[#666666] text-white p-4 w-max ">
          <Link className="font-bold text-2xl " href={"/store"}>
            ¡Ir de compras! <FontAwesomeIcon icon={faChevronRight}></FontAwesomeIcon>
          </Link>
        </p>
      </div>
    )
